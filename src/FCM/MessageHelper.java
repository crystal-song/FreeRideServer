...
public class MessageHelper {
	 ...
	 */
	public static String createJsonDownstreamMessage(DownstreamMessage downstreamMessage) {
		return createJsonMessage(createAttributeMap(downstreamMessage));
	}
	 ...
	 */
	public static Map<String, Object> createAttributeMap(DownstreamMessage msg) {
		Map<String, Object> map = new HashMap<String, Object>();
		if (msg.getTo() != null) {
